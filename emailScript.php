...
// Use the PHP Mailer libraries
use PHPMailer\PHPMailer\PHPMailer;
use PHPMailer\PHPMailer\Exception;

// Load Composer's autoloader
require '/var/www/html/resources/vendor/autoload.php';
...
//-------------------- SERVER SETTINGS --------------------//
    ...
    // Enable verbose debug output - set to 0 for final, 2 for debug - 0 avoids user from being able to see any sensitive info
    $mail->SMTPDebug = 0; 
                                     
    // Specify main and backup SMTP servers, in this case, Google's SMTP Server
    ...
    $mail->Password = 'YOU_PASSWORD_HERE';   
